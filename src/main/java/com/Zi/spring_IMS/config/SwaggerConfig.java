    ...
    public OpenAPI customOpenAPI() {
        Components components = new Components()
                .addSecuritySchemes("globalHeader", new SecurityScheme()
                        ...
                        .type(SecurityScheme.Type.APIKEY)//allows you to add APIKEY
                        .in(SecurityScheme.In.HEADER)//allows you to add Header
                        .scheme("header"));
...
//                .scheme("cookie"));
        ...
        //allows you to add Authorization(just like in Postman)
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("Zi's Inventory Management System APP")
